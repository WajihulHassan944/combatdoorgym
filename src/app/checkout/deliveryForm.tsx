  ...
  return (
    <Card>
      <CardContent className="p-6">
        <h2 className="text-2xl font-semibold text-[#154633] mb-3 flex items-center">
          <MapPin className="mr-2 h-5 w-5 text-[#154633]" />
          Contact & Delivery Information
        </h2>
        <Separator />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-3">
          <div>
            <label htmlFor="fullName" className="text-base font-semibold text-[#154633]">
              Full Name<span>*</span>
            </label>
            <Input
              id="fullName"
          ...
          <div>
            <label htmlFor="phone" className="text-base font-semibold text-[#154633]">
          ...
          <div>
            <label htmlFor="email" className="text-base font-semibold text-[#154633]">
              Email Address
            </label>
            <Input
              id="email"
          ...
          <div>
            <label htmlFor="address" className="text-base font-semibold text-[#154633]">
          ...
          <div>
            <label htmlFor="city" className="text-base font-semibold text-[#154633]">
              City<span>*</span>
            </label>
            <Input
              id="city"
          ...
          <div>
            <label htmlFor="zipCode" className="text-base font-semibold text-[#154633]">
              ZIP Code<span>*</span>
            </label>
            <Input
              id="zipCode"
          ...
          <div className="space-y-2 md:col-span-2">
            <label htmlFor="notes" className="text-base font-semibold text-[#154633]">
