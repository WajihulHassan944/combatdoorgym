...
const PaymentForm = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const parsedDelivery = deliveryMethod ? JSON.parse(deliveryMethod) : { method: 'standard', price: 20.00 };
  ...
  return (
    <Card className="mx-auto bg-white rounded-xl p-6">
      <h2 className="text-2xl font-semibold text-[#154633] mb-3 flex items-center gap-2">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-base font-semibold text-[#154633]">
            Card Holder Name
          </label>
          <Input
            required
        ...
        <button
          ...
          className="w-full bg-[#154633] text-white py-4 rounded-full font-semibold text-lg hover:bg-[#68b75f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
        >
