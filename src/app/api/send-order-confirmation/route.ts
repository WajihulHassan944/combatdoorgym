...
export async function POST(request: Request) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: email,
      subject: `Combat Door Gym - Order Confirmation #${orderData.orderNumber}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #044588;">Thank you for your order!</h1>
          <p>We're excited to confirm your Combat Door Gym order.</p>
          ...
          <div style="background-color: #f3f4f6; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <div style="margin: 20px 0;">
              ...
              <p>Product: Combat Door Gym Original</p>
