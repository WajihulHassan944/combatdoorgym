...
import Pro1 from "./../../public/images/prood6.png";
import Pro2 from "./../../public/images/prood7.png";
import Pro3 from "./../../public/images/prood10.png";
import Pro4 from "./../../public/images/product1.png";
import Pro5 from "./../../public/images/product2.png";
import Pro6 from "./../../public/images/product3.jpg";
import Pro7 from "./../../public/images/prood12.png";
import Pro8 from "./../../public/images/prood13.png";
import Pro9 from "./../../public/images/prood14.png";
...
export function ProductSection(): JSX.Element {
  ...
  const productData: ProductDataType = {
    ...
    reviewCount: 138,
    description:
      "Proven to help protect athletes in a way other equipment can't.",
  ...
  return (
    <section id="product" className="max-w-[1240px] mx-auto mb-20 px-2 md:px-0 pt-32 pb-12">
      <div className="flex flex-col md:flex-row gap-8 md:h-[654px]">
        <div className="flex flex-col md:flex-row w-full md:w-auto">
          ...
          <div className="hidden md:flex flex-col mr-4 h-[654px] relative">
            {showTopArrow && (
              <button
                className="absolute top-0 left-0 right-0 bg-[#154633] py-3 z-10 flex justify-center"
                onClick={scrollUp}
              >
            ...
            {showBottomArrow && (
              <button
                className="absolute bottom-0 left-0 right-0 bg-[#154633] py-3 z-10 flex justify-center"
                onClick={scrollDown}
              >
          ...
          <div className="flex-1 flex flex-col">
            <div>
              <div className="flex flex-col md:flex-row justify-between items-start gap-2">
                ...
                <span className="text-2xl md:text-[3px] font-semibold text-[#222222]">
                  {productData.price}
                </span>
              </div>
              ...
              <p className="mt-4 text-base md:text-lg text-[#444]">
                The Combat Door Gym is engineered for athletes who demand the best in protection and performance. Designed with advanced materials and tested in the toughest conditions, it offers unparalleled comfort and security, making it the top choice for professionals and enthusiasts alike.
              </p>
              <div className="mt-4 md:mt-6">
                <p className="text-[#000] text-sm md:text-base">
                  ...
                  <a
                    href="#learn-more"
                    className="text-[#154633] hover:underline ml-1 font-semibold"
                  >
                    Learn how it works.
                  </a>
                </p>
          ...
          <div className="mt-6 md:mt-8">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 gap-3">
              ...
              <span className="font-semibold text-base md:text-lg">
                Total: <span className="text-[#154633]">${totalPrice}</span>
              </span>
            </div>
            <div className="flex justify-end items-baseline">
              <button
                className="bg-[#154633] cursor-pointer text-white px-6 md:px-8 py-4 md:py-5 w-full rounded-full text-base md:text-lg font-bold hover:bg-[#154633]/90 transition"
