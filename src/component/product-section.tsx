        ...
        <div className="flex flex-col gap-4">
          {images.map((img, index) => (
            ...
            >
              <Image
                src={img}
                alt={`Combat Door Gym view ${index + 1}`}
                fill
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold">Combat Door Gym</h1>
          ...
          <p className="text-gray-700 mt-6">
            Combat Door Gym is a refreshing and invigorating drink that is perfect
          ...
          <p className="text-gray-700 mt-6">
            ...
            of Combat Door Gym. At once, it&apos;s nourishing and intoxicating.Most
        ...
        <div className="space-y-6 mt-auto pt-6">
          ...
          <button 
            ...
            className="w-full py-4 bg-[#2c4155] text-white font-semibold rounded-full hover:bg-[#2c4155] transition-colors cursor-pointer"
          >
            Add to Cart
          </button>
